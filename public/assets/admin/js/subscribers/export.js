                        ...
                        t.preventDefault(), r && r.validate().then((function (t) {
                            ...
                            "Valid" == t ?
                                $.ajax({
                                    ...
                                    type: "get",
                                    url: $("#app_url").val() + "/report/customers",
                                    data: {
                                        type: type,
                                        from: from,
                                        to: to,
                                        ...
                                        (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, setTimeout((function () {
                                            e.removeAttribute("data-kt-indicator"), Swal.fire({
                                                ...
                                                t.isConfirmed && (a.hide(), e.disabled = !1)
                                                    ...
                                                    var filename = (matches != null && matches[1] ? matches[1] : 'customers.pdf');
                                                    if (type == 1) {
                                                        filename = (matches != null && matches[1] ? matches[1] : 'customers.xlsx');
                                                    } else if (type == 2) {
                                                        filename = (matches != null && matches[1] ? matches[1] : 'customers.csv');
                                                    }
