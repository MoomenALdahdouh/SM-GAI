...
$(function () {
    ...
    function delete_customer(id) {
        $.ajax({
            ...
            type: "DELETE",
            url: app_url + "/admin/customers/delete/" + id,
    ...
    function get_customers() {
        var KTCustomersList = function () {
            var t, e, n = () => {
                t.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach((t => {
                    t.addEventListener("click", (function (t) {
                        t.preventDefault();
                        const n = t.target.closest("tr"),
                            o = n.querySelector('[data-kt-customer-table-filter="customer_name"]').innerText;
                        Swal.fire({
                            text: language === "en" ? "Are you sure you want to delete this item?" : "هل أنت متأكد أنك تريد حذف هذا البند؟",
                            icon: "warning",
                            showCancelButton: !0,
