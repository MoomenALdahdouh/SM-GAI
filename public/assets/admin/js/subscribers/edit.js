$(function () {
    const language = $('#language').val(),
        ...
        submit_button = document.getElementById("kt_modal_update_customer_submit"),
            ...
            $.ajax({
                ...
                success: function (response) {
                    if ($.isEmptyObject(response.error)) {
                        uploaded_image_view.attr("src", app_url + "/" + assets_url + "/uploads/customers/" + response["success"]["image"])
