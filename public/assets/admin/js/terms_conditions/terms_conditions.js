$(function () {
    const language = $('#language').val(),
        submit_button = document.getElementById("kt_ecommerce_edit_terms_conditions_submit"),
        description_input = $("#terms_conditions_description"),
        description_en_input = $("#terms_conditions_description_en"),
        app_url = $('#app_url').val(),
        add_terms_conditions_form = $("#kt_ecommerce_edit_terms_conditions_form");
    ...
    function edit_terms_conditions() {
        submit_button.addEventListener('click', function () {
            ...
            $.ajax({
                ...
                type: "POST",
                url: app_url + "/admin/terms-conditions/store",
                data: {
                    terms_conditions_description: description,
                    terms_conditions_description_en: description_en,
                },
    ...
    function success_submit(id) {
        //Success Submit
        $(".errors").html("");
        add_terms_conditions_form.attr("data-kt-redirect", app_url + "/admin");
        (submit_button.setAttribute("data-kt-indicator", "on"), submit_button.disabled = !0, setTimeout((function () {
            submit_button.removeAttribute("data-kt-indicator"), Swal.fire({
                ...
                e.isConfirmed && (submit_button.disabled = !1, window.location = add_terms_conditions_form.attr("data-kt-redirect"))
            }))
