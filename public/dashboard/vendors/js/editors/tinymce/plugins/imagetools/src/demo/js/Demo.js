...
define("tinymce/imagetoolsplugin/Demo", [
	...
	return function() {
		var imgSrc = '../../../../../../../tests/manual/web_page_img/dogleft.jpg';

		$(
			'<textarea class="tinymce">' +
				'<p>' +
					'<web_page_img src="' + imgSrc + '" width="160" height="100">' +
					'<web_page_img src="' + imgSrc + '" style="width: 160px; height: 100px">' +
					'<web_page_img src="' + imgSrc + '" style="width: 20%">' +
					'<web_page_img src="' + imgSrc + '">' +
					'<web_page_img src="http://moxiecode.cachefly.net/tinymce/v9/images/logo.png">' +
				'</p>' +
			'</textarea>'
		).appendTo('#ephox-ui');
