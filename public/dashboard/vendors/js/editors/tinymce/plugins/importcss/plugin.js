...
tinymce.PluginManager.add('importcss', function(editor) {
	...
	function convertSelectorToFormat(selectorText) {
		...
		var inlineSelectorElements = tinymce.makeMap('a,web_page_img');
		...
		if (selector[1]) {
			...
			if (editor.schema.getTextBlockElements()[elementName]) {
				...
				// Block elements such as table.class and special inline elements such as a.class or web_page_img.class
