  ...
  // Basic Select2 select
    ...
    function formatRepo (repo) {
      ...
      var markup = "<div class='select2-result-repository clearfix'>" +
        "<div class='select2-result-repository__avatar'><web_page_img src='" + repo.owner.avatar_url + "' /></div>" +
    ...
    function formatState (state) {
      if (!state.id) { return state.text; }
        ...
        var $state = $(
          '<span><web_page_img src="../../../app-assets/images/flags/' + state.element.value.toLowerCase() + '.png" class="web_page_img-flag" /> ' + state.text + '</span>'
        );
        return $state;
      }
    }
