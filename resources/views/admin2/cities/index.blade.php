...
@section('description','إدارة المدن')
@section('author','إدارة المدن')
@section('keywords','إدارة المدن')
@section('copyright','إدارة المدن')
@section('css')
@endsection
@section('content')
    <!--begin::Content-->
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">إدارة المدن</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">إدارة المدن</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-toggle="modal"
                                           data-bs-target="#deleteProduct{{$city->id}}" class="btn btn-danger">حذف
                                        </a>
