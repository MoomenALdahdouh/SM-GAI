...
@section('title','إدارة الاشعارات ')
@section('description','إدارة الاشعارات ')
@section('author','إدارة الاشعارات ')
@section('keywords','إدارة الاشعارات ')
@section('copyright','إدارة الاشعارات ')
@section('css')
@endsection
@section('content')
    <!--begin::Content-->
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div id="filter_perant" class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('notifications.create') }}" class="btn btn-primary font-weight-bolder  mb-1">
                                    ارسال اشعار جديدة
                                </a>
                            </div>
                            <!--end::Card toolbar-->
