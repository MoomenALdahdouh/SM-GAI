...
@section('title','إدارة طلبات المستخدمين ')
@section('description','إدارة طلبات المستخدمين ')
@section('author','إدارة طلبات المستخدمين ')
@section('keywords','إدارة طلبات المستخدمين ')
@section('copyright','إدارة طلبات المستخدمين ')
@section('css')
@endsection
@section('content')
    <!--begin::Content-->
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">إدارة طلبات المستخدمين</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">إدارة طلبات المستخدمين</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div id="filter_perant" class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            <div class="card-toolbar">
                                <a href="{{route('orders.index') }}" class="btn btn-primary  mb-1"> الكل</a>
                                <span>|</span>
                                <a  href="{{route('orders.index',['status'=>'PENDING']) }}" class="btn btn-danger mb-1">المعلق</a>
                                <span>|</span>
                                <a  href="{{route('orders.index',['status'=>'IN_PROGRESS']) }}" class="btn btn-warning mb-1">في الطريق</a>
                                <span>|</span>
                                <a  href="{{route('orders.index',['status'=>'FINISHED']) }}" class="btn btn-success mb-1">تم الاستلام</a>
                            </div>
                            <!--end::Card toolbar-->
                            <!--end::Add forms-->
                        </div>
