        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> المستخدمين المحذوفة </h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">المستخدمين المحذوفة المحذوفة</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 250px">
                                        ...
                                        @if($customer->status != "REJECTED" || $customer->status == "ACCEPTED")
                                            ...
                                            <span>|</span>
                                        @endif
                                        <a href="" class="btn btn-danger mb-1" data-toggle="modal"
