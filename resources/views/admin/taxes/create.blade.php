    ...
    <div class="content-body">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">إضافة ضريبة</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/')}}l">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('taxes.index')}}">إدارة الضريبة</a>
                            </li>
                            <li class="breadcrumb-item"><a href="#">اضافة الضريبة</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-top-bottom-left">إضافة ضريبة</h4>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="number" required class="form-control" placeholder="قيمة الضريبة:"
