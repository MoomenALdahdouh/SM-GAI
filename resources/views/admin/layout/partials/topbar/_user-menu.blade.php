...
<div
    ...
    <div class="menu-item px-5">
        <a data-bs-target="#newUser" data-bs-toggle="modal"
           class="menu-link px-5 {{str_contains($url,"profile")? "active":""}}">الملف الشخصي</a>
    ...
    <form action="{{ route('logout') }}" method="post" class="menu-item px-5">
        @csrf
        <button type="submit" class="menu-link px-5 btn p-2" style="width: 100% !important;">تسجيل الخروج</button>
    </form>
    <!--end::Menu item-->
</div>
<!--end::Menu-->
